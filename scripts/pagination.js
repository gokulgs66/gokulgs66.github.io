...
function generatehead() {
  ...
  // var headingData = ["Post ID", "ID", "Name", "Email", "Body"];
  var headingData = Object.keys(data[0]);
  for (let i = 0; i < headingData.length; i++) {
    heading += "<th>" + headingData[i] + "</th>";
  }

  document.getElementById("heading").innerHTML = heading;
}

function generateSigngleRow(singledata) {
  // let singledata = {
  //   userId: 1,
  //   id: 1,
  //   title:
  ...
  // };
  let keys = Object.keys(singledata);
  // console.log(keys);
  let singleRowData = keys
    .map((e) => {
      return "<td>" + singledata[e] + "</td>";
    })
    .join("");
...
function diaplaypage(page) {
  let start = (page - 1) * 10;
  let end = start + 10;
  cpage = page;
  // generate logic
  let modifiedData = data.slice(start, end);
  let displayData = modifiedData
    .map((e, i) => {
      // if (i === 0) console.log(e);
      return "<tr>" + generateSigngleRow(e) + "</tr>";
    })
    .join("");
